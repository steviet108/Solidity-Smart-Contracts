...
*/
// Here is the version of the compiler we are asking solidity to use to compile the code
...
contract JointSavings {
    ...
    */
    ...
    This fallback function exists because the contract JointSavings is its own account with a address and we want ether that is 
    sent directly to the contract to be accepted.*/
